...
import ReactFlow, {addEdge, Background, BackgroundVariant, Controls, FlowElement, isNode} from "react-flow-renderer";
...
import EdgeType from "../edgeType/edgeType.component";
    ...
    return (
        <Box className={classes.root}>
            ...
            <ReactFlow elements={nodesStates.nodes}
                       ...
                       edgeTypes={}
                       connectionLineComponent={EdgeType}
            >
                <Background
